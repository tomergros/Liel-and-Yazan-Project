...
# Section 1
st.header('זיהוי בריונות ברשתות החברתיות באמצעות בינה מלאכותית')
...
# Section 6
st.header('דוגמא מתוך סט הנתונים בעברית וערבית בנפרד')
...
# Section 7
st.header('מדדים להערכות ביצועים')
...
# Section 8
st.header('הערכת ביצועים על סט הנתונים בעברית')
...
# Section 9
st.header('הערכת ביצועים על סט הנתונים בערבית')
...
# Section 10
st.header('הערכת ביצועים על סט הנתונים בעברית + ערבית')
